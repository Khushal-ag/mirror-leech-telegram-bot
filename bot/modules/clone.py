...
from bot import dispatcher, DUMP_CHAT_ID, LOGGER, CLONE_LIMIT, STOP_DUPLICATE, download_dict, download_dict_lock, Interval
...
def cloneNode(update, context):
    ...
    if is_gdrive_link(link):
        ...
        if button in ["cancelled", ""]:
            ...
            sendDump(DUMP_CHAT_ID, result + cc, context.bot, update, button)
    else:
